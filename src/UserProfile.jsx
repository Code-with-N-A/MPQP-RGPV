      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="absolute right-0 mt-4 w-72 bg-white rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.15)] border border-gray-100 z-[200] overflow-hidden"
          >
            {!user ? (
  ...
  return (
    <button
      ...
      className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all duration-200 font-semibold text-sm group ${
        highlight ? "bg-indigo-50/50 text-indigo-700 hover:bg-indigo-50" : "text-gray-600 hover:bg-gray-50 hover:text-gray-900"
      }`}
    >
